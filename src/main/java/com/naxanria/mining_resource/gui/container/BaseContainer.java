...
/*
  @author: Naxanria
*/
public abstract class BaseContainer<TE extends TileEntity> extends Container
{
  public final TE tileEntity;
  public final PlayerInventory playerInventory;
  
  public BaseContainer(@Nullable ContainerType<?> type, int id, World world, BlockPos pos, PlayerInventory playerInventory)
  {
    super(type, id);
